...
SECTION data vstart=0
    message_1 db 0x0d, 0x0a, '[USER TASK]: Hi! nice to meet you, I am run at CPL=',
    cpl       db  0, '.', 0x0d, 0x0a, 0
    message_2 db 0x0d, 0x0a, '[USER TASK]: I needs to have a rest...', 0x0d, 0x0a, 0
    message_3 db 0x0d, 0x0a, '[USER TASK]: I am back again. Now,I must exit...', 0x0d, 0x0a, 0
